...
const UserProfile = ({ match, users }) => {
  ...
  return (
    <>
      <div className='row d-flex flex-column justify-content-center align-items-center py-5' style={{backgroundColor:'beige'}}>
      ...
      <div className='row d-flex justify-content-center text-center p-5 rounded-lg' style={{ backgroundColor: '#3f51b524' }}>
